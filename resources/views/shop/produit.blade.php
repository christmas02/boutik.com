        ...
        <div class="flex flex-col justify-center">
            ...
            <div class="border-t border-slate-100 pt-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <button id="addcart"
                            class="btn-primary flex-1 sm:flex-none text-base px-8 py-3.5">
                        <svg class="mr-2 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>
                        </svg>
                        Ajouter au panier
                    </button>
                    <a href="https://wa.me/s2250700780244?text=Bonjour,%20je%20suis%20intéressé%20par%20ce%20produit:%20{{ urlencode($product['name']) }}%20%0A{{ urlencode(request()->url()) }}"
                       target="_blank"
