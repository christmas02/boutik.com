    ...
    <tr>
        <td>
            <table style="background-color: #fff; width: 100%">
                ...
                <tr>
                    <td>
                        <table style="margin: 0 auto; margin-bottom: 30px; padding: 30px">
                            <tbody>
                            <tr class="logo-sec" style="display: flex; align-items: center; justify-content: space-between; width: 650px;">
                                ...
                                <td style="text-align: right; color:#999">
                                    <span>Commande n. : 2280268814 <br> Passée le : 09/08/2025 14:36</span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
            ...
            <table style="margin: 0 auto; background-color: #fff; border-radius: 8px">
                ...
                <tr>
                    <td style="padding: 30px">
                        <h6 style="font-weight: 600">Merci pour votre commande 2280268814.</h6>
                        <p>
            ...
            <table style="width:100%;margin:0px 0 10px 0;padding:0px 30px">
                ...
                <tr>
                    <td style="padding:20px 25px 20px 0" width="80">
                        <a href="#" style="color:#000000;text-decoration:none" ><img alt="" src="https://ci3.googleusercontent.com/meips/ADKq_NYJxlfOFddHcuhRMUXH7tyS-yfGhtgIXnZHwst0JdeQz58CmvN9xRA5u3CquKBisVq8JlfbFloLGcDsHJjEzP0_hOxVVv9aozcE3f4_HODohPI=s0-d-e1-ft#https://cdn.notinoimg.com/mail1/afnan/6290171075073_01-o.jpg" style="display:block" width="80" ></a>
                    </td>
                    <td style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#000000;line-height:20px;padding:25px 20px 15px 0" valign="top">
                        <a href="#" style="color:#000000;text-decoration:none" >Afnan Supremacy Collector's Edition Eau de Parfum pour homme 100 ml</a>
                        <br>
                    </td>
                    <td style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#000000;text-align:right;padding:25px 0 0 0" valign="top" width="60">1&nbsp;pcs</td>
                    <td style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#000000;text-align:right;padding:25px 0 0 0" valign="top" width="105">48,00&nbsp;€</td>
                </tr>
                <tr>
